<script lang="ts">
  ...
  >
    ...
    >
      <div class="w-full h-full max-w-4xl bg-center bg-no-repeat bg-contain opacity-80"
    ...
    >
      <div class="w-40 h-40 bg-center bg-no-repeat bg-contain opacity-70"
           style="background-image: url('https://static.vecteezy.com/system/resources/previews/042/960/123/non_2x/ai-generated-gamepad-in-the-hands-of-a-gamer-on-a-technological-background-neon-lighting-video-games-online-with-friends-winnings-prizes-fun-entertainment-youth-culture-virtual-reality-photo.jpg');">
      </div>
    </div>
    ...
    <div 
      ...
      class="absolute left-20 bottom-20 transition-all duration-300 ease-out"
    >
      <div class="w-40 h-40 bg-center bg-no-repeat bg-contain opacity-70"
           style="background-image: url('https://static.vecteezy.com/system/resources/previews/042/960/123/non_2x/ai-generated-gamepad-in-the-hands-of-a-gamer-on-a-technological-background-neon-lighting-video-games-online-with-friends-winnings-prizes-fun-entertainment-youth-culture-virtual-reality-photo.jpg');">
      </div>
    ...
    <div 
      bind:this={content}
      class="relative z-10 flex flex-col items-start justify-center h-screen px-6 sm:px-12 lg:px-24 transition-all duration-300"
    >
      <div class="max-w-4xl">
        <h1 class="mb-6 text-4xl sm:text-5xl md:text-6xl font-bold text-white text-shadow-neon-purple">
          Jual Beli Barang Kamu<br />
          <span class="block mt-2">di SK8 Consign</span>
        </h1>
        
        <div class="flex flex-wrap gap-4 mt-8">
          <a 
            href="#" 
            class="inline-flex items-center px-6 py-3 rounded-full bg-black border border-gray-700 text-white hover:bg-gray-900 transition-colors"
          >
